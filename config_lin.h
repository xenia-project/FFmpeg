...
#define FFMPEG_CONFIGURATION "--cc=clang-9 --arch=x86_64 --disable-everything --disable-programs --disable-all --disable-x86asm --disable-autodetect --enable-avcodec --enable-avutil --enable-decoder=xmaframes"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "clang version 9.0.0-2~ubuntu18.04.2 (tags/RELEASE_900/final)"
