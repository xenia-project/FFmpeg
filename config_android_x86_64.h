...
#define FFMPEG_CONFIGURATION "--cc=/home/joel/Documents/dev/android-ndk-r23/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android24-clang --enable-cross-compile --arch=x86_64 --target-os=android --disable-everything --disable-programs --disable-all --disable-x86asm --disable-autodetect --enable-avcodec --enable-avutil --enable-decoder=xmaframes"
