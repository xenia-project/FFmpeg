...
#define FFMPEG_CONFIGURATION "--cc=/home/joel/Documents/dev/android-ndk-r23/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang --enable-cross-compile --arch=aarch64 --target-os=android --disable-everything --disable-programs --disable-all --disable-autodetect --enable-avcodec --enable-avutil --enable-decoder=xmaframes"
