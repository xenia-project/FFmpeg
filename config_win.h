...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --disable-everything --disable-programs --disable-all --disable-x86asm --disable-autodetect --enable-avcodec --enable-avutil --enable-decoder=xmaframes"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.28.29913 for x64"
